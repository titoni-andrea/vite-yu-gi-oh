...
<template>
    <main>
        <div class="ris-ricerca">
            <h4>Fuond 39 cards</h4>
        </div>
        <div class="cont-card">
            <div v-for="carta, i in dati" class="card">
                <img :src="dati[i].card_images[0].image_url" alt="">
                <h3 class="titolo-carta">{{ dati[i].name }}</h3>
                <p>{{ dati[i].archetype }}</p>
